...
class PSO():
    ...
    def __init__(self, mode='regular', swarmsize = 100, iterations = 100, rand_init = False, omega = 0.5, c1 = 0.5, c2 = 0.5, T1 = 1e-10, T2 = 1e-10, CONVERGENCE = False, PROCESSES = 1, function = 0):
        if mode != 'regular':
